                ...
                <table className="w-full text-left table-auto min-w-max">
                    ...
                    <tbody>
                        {fletes && fletes.map((flete: any, index: number) => (
                            <tr className={index % 2 ? "bg-stone-600 text-sm hover:bg-black hover:text-white border-b border-slate-200" : "text-sm hover:bg-black hover:text-white border-b border-slate-200"} key={flete.id}>
